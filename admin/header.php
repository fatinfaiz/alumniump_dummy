      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="newevent.php"><i class="fa fa-circle-o"></i>Create New Event</a></li>
                  <li><a href="eventlist.php"><i class="fa fa-circle-o"></i>List of Alumni Events</a></li>
              </ul>
            </li>
        ...
        <i class="fa fa-angle-left pull-right"></i>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="registeremployee.php"><i class="fa fa-circle-o"></i>Register New Exco</a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="registermember.php"><i class="fa fa-circle-o"></i> Register New Member</a></li>
                <li><a href="updatemember.php"><i class="fa fa-circle-o"></i>List of Alumni Member</a></li>
                <li><a href="employmentstatus.php"><i class="fa fa-circle-o"></i>Alumni Employment Status</a></li>
                <li><a href="search.php"><i class="fa fa-circle-o"></i>Alumni Member Report</a></li>
              </ul>
            </li>
