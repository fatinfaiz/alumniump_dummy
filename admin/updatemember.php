  ...
  <h3>Lists of Alumni UMP Member</h3>
    ...
    ?>
                ...
                <td style="width: 20%"> <a class="btn btn-sm btn-info pull-left" style='margin-right: 5px;' href="memberprofile.php?id=<?php echo $row['RM_USER_ID'];?>" target="_new">View</a>&nbsp;&nbsp;
                    ...
                    <a class="btn btn-sm btn-warning pull-left" style='margin-right: 5px;' href="removemember.php?id=<?php echo $row['RM_USER_ID']; ?>" onclick="return confirm('Are you sure you want to remove member from the list?');" data-toggle="modal" rel="tooltip" data-original-title='Hello' role="button"><span class="glyphicon glyphicon-trash"></span></a>
