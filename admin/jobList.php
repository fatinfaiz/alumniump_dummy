		...
		?>
            <tr>
                ...
                <td style="width: 25%"> 
                    ...
                    <a class="btn btn-sm btn-success pull-left" style='margin-right: 5px;' onclick="change_status(<?php echo $row['ADS_ID']; ?>, 'Approved'); return false;"><span class="glyphicon glyphicon-edit" target="_blank">Approve</span></a>

                    <a class="btn btn-sm btn-danger pull-left" style='margin-right: 5px;' onclick="change_status(<?php echo $row['ADS_ID']; ?>,'Not Approved'); return false;">Reject</a>
                </td>
            </tr>
            <?php 
            $i++;
